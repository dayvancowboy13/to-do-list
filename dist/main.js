...
#side-bar {
    grid-column: 1/2;
    display: grid;
    background-color: var(--br-400);
    max-width: 15vw;
    border: dashed var(--br-950) 1px;
    padding: 6px;
...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,YAAY;;IAEZ,gBAAgB;IAChB,iBAAiB;IACjB,iBAAiB;IACjB,iBAAiB;IACjB,iBAAiB;IACjB,iBAAiB;IACjB,iBAAiB;IACjB,iBAAiB;IACjB,iBAAiB;IACjB,iBAAiB;IACjB,iBAAiB;;KAEhB,yCAAyC;AAC9C;;AAEA;IACI,YAAY;IACZ,+BAA+B;;IAE/B;QACI,oBAAoB;IACxB;AACJ;;AAEA;IACI,aAAa;IACb,8BAA8B;AAClC;;;AAGA;IACI,gBAAgB;IAChB,aAAa;IACb,+BAA+B;IAC/B,eAAe;IACf,gCAAgC;IAChC,YAAY;;IAEZ;QACI,oBAAoB;QACpB,oBAAoB;QACpB,eAAe;IACnB;AACJ;;AAEA;IACI,+BAA+B;IAC/B,gBAAgB;;IAEhB;QACI,WAAW;IACf;AACJ;;AAEA;IACI,gBAAgB;IAChB,YAAY;IACZ,6BAA6B;IAC7B,+BAA+B;IAC/B,uBAAuB;IACvB,WAAW;IACX,gBAAgB;IAChB,aAAa;AACjB;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,mBAAmB;IACnB,mBAAmB;IACnB,sBAAsB;IACtB,uBAAuB;AAC3B;;AAEA;IACI,aAAa;IACb,uBAAuB;IACvB,uBAAuB;IACvB,kBAAkB;IAClB,cAAc;IACd,YAAY;;;IAGZ,QAAQ;;IAER;QACI,iBAAiB;QACjB,YAAY;IAChB;IACA;QACI,iBAAiB;QACjB,UAAU;IACd;AACJ;;AAEA;IACI,qBAAqB;AACzB;;AAEA;IACI,kBAAkB;IAClB,eAAe;AACnB","sourcesContent":[":root {\n    /* #0170f1 */\n\n    --br-50: #edfaff;\n    --br-100: #d6f1ff;\n    --br-200: #b6e9ff;\n    --br-300: #83ddff;\n    --br-400: #49c7ff;\n    --br-500: #1fa8ff;\n    --br-600: #078aff;\n    --br-700: #0170f1;\n    --br-800: #085ac5;\n    --br-900: #0e4e9a;\n    --br-950: #0e305d;\n\n     font-family: Helvetica, Arial, sans-serif;\n}\n\nheader {\n    display:grid;\n    background-color: var(--br-700);\n\n    & h1 {\n        justify-self: center;\n    }\n}\n\n#main-container {\n    display: grid;\n    grid-template-columns: 1fr 1fr;\n}\n\n\n#side-bar {\n    grid-column: 1/2;\n    display: grid;\n    background-color: var(--br-400);\n    max-width: 15vw;\n    border: dashed var(--br-950) 1px;\n    padding: 6px;\n\n    & h1 {\n        justify-self: center;\n        color: var(--br-950);\n        font-size: 24px;\n    }\n}\n\n#existing-projects{\n    background-color: var(--br-600);\n    list-style: none;\n    \n    & li {\n        margin: 5px;\n    }\n}\n\n#todo-display {\n    grid-column: 2/3;\n    display:grid;\n    /* justify-content: center; */\n    background-color: var(--br-200);\n    border: solid black 2px;\n    width: 80vw;\n    min-height: 10em;\n    padding: 20px;\n}\n\n.project-name, .project-delete, .card-button {\n    cursor: pointer;\n}\n\n.project-count {\n    /* display: flex; */\n    font-weight: bolder;\n    padding: 0 10px 0 10px;\n    /* justify-self: end; */\n}\n\n.todo-card {\n    display: flex;\n    justify-content: center;\n    border: solid black 1px;\n    border-radius: 8px;\n    max-width: 50%;\n    height: 50px;\n\n    \n    gap: 8px;\n\n    & #edit-btn {\n        justify-self: end;\n        color: white;\n    }\n    & #del-btn {\n        justify-self: end;\n        color: red;\n    }\n}\n\n.todo-card.todo-inactive {\n    background-color: red;\n}\n\n.details-dialog-label {\n    padding-right: 6px;\n    font-weight:800;\n}\n    \n"],"sourceRoot":""}]);
// Exports
...
class DOMController {
    ...
    static #createTaskCard(todo, mode="regular"){
        ...
        if (mode === "regular"){
            ...
            spanDueDate.textContent = date_fns__WEBPACK_IMPORTED_MODULE_3__.format(todo.dueDate, "MMM-dd-yyyy");
            ...
            spanTitle.textContent = todo.todo.title;
            spanDueDate.textContent = date_fns__WEBPACK_IMPORTED_MODULE_3__.format(todo.todo.dueDate, "MMM-dd-yyyy");
            const spanSource = document.createElement("span");
            spanSource.id = "card-source";
            spanSource.classList = "task-card";
            spanSource.textContent = `From: ${todo.srcProject}`;
    ...
    static #renderDetails (title, desc, dueDate, priority){
        ...
        document.querySelector('#details-duedate').textContent = date_fns__WEBPACK_IMPORTED_MODULE_3__.format(dueDate, "MMM-dd-yyyy");
    ...
    static #Edit(todo){
        ...
        document.querySelector("#due_date_edit").value = date_fns__WEBPACK_IMPORTED_MODULE_3__.format(todo.dueDate, "yyyy-MM-dd");
...
_DOMController_js__WEBPACK_IMPORTED_MODULE_0__["default"].initialize();

        ...
        if (projectName === "Inbox"){
            ...
            for (let child of projectList.children){
                ...
                if(projectName === child.children[0].textContent){
                    const activeTasks = _ProjectMaster__WEBPACK_IMPORTED_MODULE_1__["default"].getProjectFromArray(projectName).activeTaskCount;
                    console.log(_ProjectMaster__WEBPACK_IMPORTED_MODULE_1__["default"].getProjectFromArray(projectName));
                    if(activeTasks !== 0){

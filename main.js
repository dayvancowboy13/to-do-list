...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,YAAY;;IAEZ,gBAAgB;IAChB,iBAAiB;IACjB,iBAAiB;IACjB,iBAAiB;IACjB,iBAAiB;IACjB,iBAAiB;IACjB,iBAAiB;IACjB,iBAAiB;IACjB,iBAAiB;IACjB,iBAAiB;IACjB,iBAAiB;;KAEhB,yCAAyC;AAC9C;;AAEA;IACI,YAAY;IACZ,+BAA+B;;IAE/B;QACI,oBAAoB;IACxB;AACJ;;AAEA;IACI,aAAa;IACb,8BAA8B;AAClC;;;AAGA;IACI,gBAAgB;IAChB,aAAa;IACb,+BAA+B;IAC/B,eAAe;IACf,qCAAqC;IACrC,YAAY;;IAEZ;QACI,oBAAoB;QACpB,oBAAoB;QACpB,eAAe;IACnB;;IAEA;QACI,eAAe;QACf,yBAAyB;QACzB,WAAW;QACX,iBAAiB;QACjB,gBAAgB;QAChB,qCAAqC;QACrC,YAAY;QACZ,kBAAkB;QAClB,oBAAoB;;QAEpB,WAAW;QACX,iBAAiB;;;IAGrB;;IAEA;QACI,iBAAiB;QACjB,mBAAmB;;IAEvB;AACJ;;;AAGA;IACI,qCAAqC;IACrC,gBAAgB;;IAEhB;QACI,WAAW;IACf;AACJ;;AAEA;IACI,gBAAgB;IAChB,YAAY;IACZ,+BAA+B;IAC/B,6BAA6B;IAC7B,WAAW;IACX,gBAAgB;IAChB,aAAa;AACjB;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,aAAa;IACb,8BAA8B;AAClC;;AAEA;IACI,eAAe;AACnB;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,mBAAmB;IACnB,iBAAiB;AACrB;;AAEA;;;;;;GAMG;;AAEH;;IAEI,gBAAgB;IAChB,oBAAoB;IACpB,+BAA+B;IAC/B,mBAAmB;IACnB,sBAAsB;AAC1B;;AAEA;IACI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,+BAA+B;IAC/B,oBAAoB;IACpB,kBAAkB;IAClB,cAAc;IACd,YAAY;IACZ,QAAQ;;IAER;QACI,iBAAiB;QACjB,YAAY;IAChB;IACA;QACI,iBAAiB;QACjB,UAAU;IACd;AACJ;;AAEA;IACI,sBAAsB;EACxB,4BAA4B;EAC5B,SAAS;EACT,aAAa;EACb,yBAAyB;EACzB,YAAY;EACZ,aAAa;EACb,kCAAkC;EAClC,qBAAqB;EACrB,+BAA+B;AACjC;;AAEA;IACI,+BAA+B;IAC/B,WAAW;IACX,6BAA6B;AACjC;;AAEA;IACI,kBAAkB;IAClB,eAAe;AACnB","sourcesContent":[":root {\n    /* #0170f1 */\n\n    --br-50: #edfaff;\n    --br-100: #d6f1ff;\n    --br-200: #b6e9ff;\n    --br-300: #83ddff;\n    --br-400: #49c7ff;\n    --br-500: #1fa8ff;\n    --br-600: #078aff;\n    --br-700: #0170f1;\n    --br-800: #085ac5;\n    --br-900: #0e4e9a;\n    --br-950: #0e305d;\n\n     font-family: Helvetica, Arial, sans-serif;\n}\n\nheader {\n    display:grid;\n    background-color: var(--br-500);\n\n    & h1 {\n        justify-self: center;\n    }\n}\n\n#main-container {\n    display: grid;\n    grid-template-columns: 1fr 1fr;\n}\n\n\n#side-bar {\n    grid-column: 1/2;\n    display: grid;\n    background-color: var(--br-200);\n    max-width: 15vw;\n    border-right: solid var(--br-400) 1px;\n    padding: 6px;\n\n    & h1 {\n        justify-self: center;\n        color: var(--br-950);\n        font-size: 24px;\n    }\n\n    & button, li {\n        cursor: pointer;\n        background-color: inherit;\n        margin: 5px;\n        font-size: 1.2rem;\n        font-weight: 400;\n        /* border: solid var(--br-800) 1px; */\n        border: none;\n        border-radius: 8px;\n        color: var(--br-800);\n\n        padding: 4%;\n        text-align: start;\n\n\n    }\n\n    & button:hover {\n        font-size: 1.3rem;\n        font-weight: bolder;\n\n    }\n}\n\n\n#existing-projects{\n    /* background-color: var(--br-600); */\n    list-style: none;\n    \n    & li {\n        margin: 5px;\n    }\n}\n\n#todo-display {\n    grid-column: 2/3;\n    display:grid;\n    background-color: var(--br-100);\n    /* border: solid black 2px; */\n    width: 80vw;\n    min-height: 10em;\n    padding: 20px;\n}\n\n.project-name, .project-delete, .card-button {\n    cursor: pointer;\n}\n\n#inbox {\n    display: flex;\n    justify-content: space-between;\n}\n\n#existing-projects {\n    padding-left: 0;\n}\n\nul#existing-projects > li {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    text-align: start;\n}\n\n/* ul#existing-projects > li:hover::before {\n    content: \">>\"\n}\n\nul#existing-projects > li:c {\n    content: \">>\"\n} */\n\n.project-count {\n\n    font-weight: 600;\n    color: var(--br-200);\n    background-color: var(--br-800);\n    border-radius: 20px;\n    padding: 0 10px 0 10px;\n}\n\n.todo-card {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    background-color: var(--br-600);\n    color: var(--br-100);\n    border-radius: 8px;\n    max-width: 70%;\n    height: 50px;\n    gap: 8px;\n\n    & #edit-btn {\n        justify-self: end;\n        color: white;\n    }\n    & #del-btn {\n        justify-self: end;\n        color: red;\n    }\n}\n\ninput[type=\"checkbox\"] {\n    /* appearance: none; */\n  /* background-color: #fff; */\n  margin: 0;\n  font: inherit;\n  /* color: currentColor; */\n  width: 1.3em;\n  height: 1.3em;\n  border: 0.15em solid var(--br-900);\n  border-radius: 0.15em;\n  transform: translateY(-0.075em);\n}\n\n.todo-card.todo-inactive {\n    background-color: var(--br-300);\n    color: grey;\n    text-decoration: line-through;\n}\n\n.details-dialog-label {\n    padding-right: 6px;\n    font-weight:800;\n}\n    \n"],"sourceRoot":""}]);
// Exports

...
class DOMController {
    ...
    static #Inbox(){
        ...
        console.log(_ProjectMaster__WEBPACK_IMPORTED_MODULE_1__["default"].getProjectTodos(projectName))
    }

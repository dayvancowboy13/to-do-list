...
class DOMController {
    ...
    static #displayProjectTasks (projectName){
        ...
        const todoList = _ProjectMaster__WEBPACK_IMPORTED_MODULE_1__["default"].getProjectTodos(projectName);

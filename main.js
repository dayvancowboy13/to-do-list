...
/* harmony export */ });
/* harmony import */ var _ProjectMaster__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ProjectMaster */ "./src/ProjectMaster.js");
...
class DOMController {
    ...
    static firstFunc (){
        ...
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_0__["default"].getTodaysTodos();
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_0__["default"].addToProject("Inbox", "t1", "desc", new Date(), "low")
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_0__["default"].addToProject("Inbox", "t2", "desc", new Date(2024,5,22), "high")
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_0__["default"].addToProject("Inbox", "t3", "desc", new Date(2024,5,30), "low")
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_0__["default"].addToProject("Inbox", "t4", "desc", new Date(), "low")
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_0__["default"].addToProject("Inbox", "t5", "desc", new Date(2024,5,27), "low")
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_0__["default"].addToProject("Inbox", "t6", "desc", new Date(2024,5,23), "low")
        console.log(_ProjectMaster__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectTodos("Inbox"))
    }
}

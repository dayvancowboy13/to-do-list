...
class DOMController {
    ...
    static initialize(){
        ...
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_1__["default"].createProject('p2');
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_1__["default"].createProject('p3');
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_1__["default"].createProject('Doody');
    ...
    static firstFunc (){
        ...
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_1__["default"].getTodaysTodos();
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_1__["default"].addToProject("Inbox", "t1", "desc", new Date(), "low")
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_1__["default"].addToProject("Inbox", "t2", "desc", new Date(2024,5,22), "high")
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_1__["default"].addToProject("Inbox", "t3", "desc", new Date(2024,5,30), "low")
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_1__["default"].addToProject("Inbox", "t4", "desc", new Date(), "low")
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_1__["default"].addToProject("Inbox", "t5", "desc", new Date(2024,5,27), "low")
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_1__["default"].addToProject("Inbox", "t6", "desc", new Date(2024,5,23), "low")
        console.log(_ProjectMaster__WEBPACK_IMPORTED_MODULE_1__["default"].getProjectTodos("Inbox"))
    }
}

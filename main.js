...
class DOMController {
    ...
    static initialize(){
        ...
        this.#initListeners();
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_1__["default"].createProject('p1');
        _ProjectMaster__WEBPACK_IMPORTED_MODULE_1__["default"].createProject('Web Dev');
